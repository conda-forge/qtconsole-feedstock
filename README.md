...
Installing qtconsole-base
=========================

Installing `qtconsole-base` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating qtconsole-base-feedstock
=================================

If you would like to improve the qtconsole-base recipe or build a new
...
Note that all branches in the conda-forge/qtconsole-base-feedstock are
